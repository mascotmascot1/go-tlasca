...
Большие значения (например, 8, 16, 32) позволяют учитывать соседние пиксели и сглаживать результат, но увеличивают время вычислений. Значение данного параметра не должно превышать минимальный размер сторон входных изображений.
