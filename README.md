...
Эти изображения представляют собой набор реальных последовательных спекл-снимков, запечатлевших физическую динамику микроциркуляции крови (движение в сосудистой структуре).
Исходное происхождение кадров (аппаратура, объект съёмки и т.д.) не уточняется, однако датасет является валидным и полностью подходит для демонстрации и проверки работоспособности алгоритма пространственно-временного анализа».
